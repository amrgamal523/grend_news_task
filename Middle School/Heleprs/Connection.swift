...
class Connection: NSObject {
  ...
  var showErrorDialog=true;
    ...
    func startConnection(view:UIViewController , url:String , parameter:Dictionary<String, Any>?,callback:@escaping ((DataResponse<Any>)?) -> Void ){
...
//        {
//           // Auth_header=[ "Authorization" : "Bearer " + (UserDefaults.standard.object(forKey: "accessToken") as! String)]
...
//        }
        ...
        Alamofire.request(urlwithPercentEscapes!, method: method, parameters: parameter, /*encoding: JSONEncoding.default,*/ headers: (Auth_header as! [String : String])).responseObject { (response: DataResponse<T>) in
            ...
            print("hjgjhgjhgjhghj", modelResponse?.toJSON())
