...
class VideoChatViewController: UIViewController {
    ...
    @IBOutlet weak var stopCameraBtn: UIButton!
    ...
    func setupLocalVideo() {
        ...
        localVideo!.uid = UInt(Int(Defaults.getUserId()) ?? 0)
    ...
    func joinChannel() {
        ...
        agoraKit.joinChannel(byToken: Token, channelId: order_id, info: nil, uid: UInt(Int(Defaults.getUserId()) ?? 0)) { [unowned self] (channel, uid, elapsed) -> Void in
...
//        }
    ...
    @IBAction func hideLocalCameraBtnClick(_ sender: Any) {
        if(localVideo != nil)
        {
